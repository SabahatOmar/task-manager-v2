...
#ask_blueprint = Blueprint("tasks", __name__)
...
@task_ns.route('/tasks', methods=['GET'])
...
@task_ns.route("/tasks", methods=["POST"])
@jwt_required()
def create_task():
...
@task_ns.route('/tasks/<int:task_id>', methods=['DELETE'])
@jwt_required()
...
@auth_ns.route('/deleteuser/<int:user_id>', methods=['DELETE'])
@jwt_required()
...
@tag_ns.route('/tags', methods=['POST'])
@jwt_required()
def create_tag():
    data = request.get_json()
...
@tag_ns.route('/tags/<int:task_id>', methods=['GET'])
@jwt_required()
...
@tag_ns.route('/tags/<int:task_id>', methods=['POST'])
@jwt_required()
...
@tag_ns.route('/tags/<int:task_id>', methods=['DELETE'])
@jwt_required()
...
@tag_ns.route('/tags', methods=['DELETE'])
@jwt_required()
def delete_tag():
    data = request.get_json()
